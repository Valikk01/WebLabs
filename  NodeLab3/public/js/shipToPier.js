...
function fillTable() {
    ...
    let tableContent = '';
    $.getJSON('/service/shipToPiers', function(data) {
        $.each(data, function() {
...
function showCargoOnPlanetInfo(event) {
    ...
    $.getJSON(`/service/shipToPiers/${cargoOnPlanetId}`, function(data) {
